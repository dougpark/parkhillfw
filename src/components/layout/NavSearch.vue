  ...
  <div ref="root" class="flex items-center justify-end">
    ...
    <div class="relative hidden min-w-0 sm:block sm:w-64">
      ...
      <input
        ...
        class="w-full rounded-full border border-theme-border bg-surface py-2 pl-9 pr-3 text-sm text-content placeholder:text-content-muted focus:outline-none focus:ring-2 focus:ring-accent/30 focus:border-accent"
    ...
    >
      <div class="relative">
        ...
        <input
          ...
          type="search"
          placeholder="Search directory & pages…"
          class="w-full rounded-full border border-theme-border bg-surface py-2 pl-9 pr-8 text-sm text-content placeholder:text-content-muted focus:outline-none focus:ring-2 focus:ring-accent/30 focus:border-accent"
          aria-label="Search directory and pages"
          @input="onInput"
